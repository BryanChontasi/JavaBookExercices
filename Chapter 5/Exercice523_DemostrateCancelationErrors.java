...
public class Exercice523_DemostrateCancelationErrors {
	...
	public static void main(String[] args) {
		 ...
		 * more accurate results, carefully select the order of computation. For
		 * example, in computing the following series, you will obtain more accurate
		 * results by computing from right to left rather than from left to right: 1 + 1
		 * / 2 + 1 / 3 + ... + 1 / n Write a program that compares the results of the
		 * summation of the preceding series, computing from left to right and from
