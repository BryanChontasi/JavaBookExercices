...
public class Exercice43_AreaGPS {
	...
	public static void main(String[] args) {
		...
		/*
		 * Charlotte (35.2270869, –80.8431267 Savannah (32.0835407, –81.0998342) Orlando
		 * (28.5383355, –81.3792365) Atlanta (33.7489954, –84.3879824)
		 */
		...
		double distanceChaAtl = RADIUS_OF_THE_EARTH * Math
				.acos(Math.sin(Math.toRadians(chaX)) * Math.sin(Math.toRadians(atlX)) + Math.cos(Math.toRadians(chaX))
						* Math.cos(Math.toRadians(atlX)) * Math.cos(Math.toRadians(chaY - atlY)));
		
		//distance between  Atlanta and Orlando
		double distanceAtlOrl = RADIUS_OF_THE_EARTH * Math
				.acos(Math.sin(Math.toRadians(atlX)) * Math.sin(Math.toRadians(orlX)) + Math.cos(Math.toRadians(atlX))
						* Math.cos(Math.toRadians(orlX)) * Math.cos(Math.toRadians(atlY - orlY)));
		
		//distance between Orlando and Savannah
		double distanceOrlSav = RADIUS_OF_THE_EARTH * Math
				.acos(Math.sin(Math.toRadians(orlX)) * Math.sin(Math.toRadians(savX)) + Math.cos(Math.toRadians(orlX))
						* Math.cos(Math.toRadians(savX)) * Math.cos(Math.toRadians(orlY - savY)));
		
		//distance between Savannah and Charlotte
		double distanceSavCha = RADIUS_OF_THE_EARTH * Math
				.acos(Math.sin(Math.toRadians(savX)) * Math.sin(Math.toRadians(chaX)) + Math.cos(Math.toRadians(savX))
						* Math.cos(Math.toRadians(chaX)) * Math.cos(Math.toRadians(savY - chaY)));
		
		//distance between Charlotte and Orlando
		double distanceChaOrl = RADIUS_OF_THE_EARTH * Math
				.acos(Math.sin(Math.toRadians(chaX)) * Math.sin(Math.toRadians(orlX)) + Math.cos(Math.toRadians(chaX))
						* Math.cos(Math.toRadians(orlX)) * Math.cos(Math.toRadians(chaY - orlY)));
